...
public class ProductServiceTest {
    ...
    public void shouldUpdateProduct() {
        ...
        String newDescription = "Esse con certeza é o melhor aparelho de telefone móvel ja criado na historia";
        request.setDescription(newDescription);

        Optional<ProductDTO> updateProductDTO = service.update(id, request);

        assertNotNull(updateProductDTO.get());
        assertEquals(newDescription, updateProductDTO.get().getDescription());
    }
}
